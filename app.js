...
try {
  ...
  console.log('\nTeam Rocket encountered an error while trying to load the config file, please resolve this issue and restart Team Rocket\n\n' + e.message)
  process.exit()
}
...
bot.Dispatcher.on(Event.GATEWAY_READY, function () {
  ...
  bot.User.setGame("Version 5.9.3")
