...
Commands.superwhy = {
  name: 'superwhy',
  help: 'I\'ll reply to you with Proto is beter'
  aliases: ['supay']
  timeout: 10,
  level: 0,
  fn: function (msg) {
    msg.reply('Proto is better')
  }
}
...
Commands.info = {
  ...
  fn: function (msg, suffix, bot) {
    ...
    msg.channel.sendMessage('', false, {
      ...
      title: `Running on Team Rocket version ${require('../../package.json').version}`,
      timestamp: new Date(),
      fields: field,
      description: '*My developer is SpectrumEeveez*',
      url: 'https://thetrioyt.weebly.com',
...
Commands['leave-server'] = {
  ...
  fn: function (msg) {
    if (msg.isPrivate) {
      msg.channel.sendMessage('You can not do this in a DM! Sorry m8')
    } else {
...
Commands.hello = {
  name: 'hello',
  help: 'I\'ll respond to you with hello along with who i am developed with',
  timeout: 20,
  level: 0,
  fn: function (msg, suffix, bot) {
    msg.channel.sendMessage('Hi ' + msg.author.username + ', I\'m ' + bot.User.username + 'Hello! Developed By SpectrumEeveez')
  }
}
